...
temporary_list = list(feelings)
final_list = tuple(temporary_list)
...
for i in range(3):
    ...
    hype_value.append(value)

typed_name = input("Type your name to enter the college: ")

temporary_feeling = input("What are your feelings just right now mister: ")
feelings.append(temporary_feeling)

if typed_name in classmates:
    print(f"Access granted! Welcome to your classroom, {typed_name}")
else:
    print(
        "Too bad mister, you're not a student in this institution, "
        "get out before we deport u to Siberia"
    )
...
print(f"Your hype value is {hype_value}, and they've arrived.")
